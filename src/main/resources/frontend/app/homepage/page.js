...
export default function HomePage() {
  ...
  return (
    <Box sx={{ display: "flex", bgcolor: "background.default", color: "white" }}>
      ...
      >
        <Box sx={{ p: 2 }}>
          <Typography variant="h6" fontWeight="bold">LoopCode</Typography>
        </Box>
        <List>
          {["Desafio Diário", "Criar exercício", "Criar lista"].map((text) => (
      ...
      <Box 
          sx={{ 
               ...
               overflowY: "auto", 
               maxWidth: 1200, 
               p: { xs: 2, sm: 3 }, // Opcional: padding também pode ser responsivo
               maxWidth: {
                    xs: '100%',  
                    sm: '700px',   
                    md: '900px',   
